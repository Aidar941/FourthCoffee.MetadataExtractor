...
namespace FourthCoffee.MetaDataExtractor
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ExtractAssemblyAttributes()
        {
            ...
            results.Items.Add(this.FormatComment(type.GetCustomAttribute<DeveloperInfo>(), type.Name, "Type"));

            foreach (var member in type.GetMembers())
            {
                // TODO: 02: Invoke the MemberInfo.GetCustomAttribute method.
                results.Items.Add(this.FormatComment(member.GetCustomAttribute<DeveloperInfo>(), member.Name, member.MemberType.ToString()));
            }
        }
